public class Botella extends Elemento {
    ...
    public void llenarBotella (Elemento liquido) {
        ...
        if(!isVacia()) {
            System.out.println(getNombre() + ": Se encuentra llena");
        }
        else if (liquido.getTipo() != TipoElemento.LIQUIDO) {
            System.out.println(getNombre() + ": No admite " + liquido.getTipo().toString());
        }
        else {
            contenido = liquido;
    ...
    public void generarNombre () {
        // TODO - Implementar metodo
        String mensaje = isVacia() ? " vacia" : " con " + contenido.getNombre();
        setNombre("Botella" + mensaje);
    }
    ...
    public Boolean hasAgua () {
        // TODO - Implementar metodo
        return (contenido instanceof Agua);
    }
    ...
    public Boolean hasVino () {
        // TODO - Implementar metodo
        return (contenido instanceof Vino);
    }
